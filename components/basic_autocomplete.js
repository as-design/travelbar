...
const CLASS_ID = Components.ID('54350920-08de-11e2-892e-0800200c9a66'); // ← Change this
...
ProviderAutoCompleteSearch.prototype = {
  ...
  startSearch: function(searchString, searchParam, previousResult, listener) {
    ...
    for (var i=0; i<searchResults.length; i++) {
      if (searchString == searchResults[i].value.toLowerCase().substring(0, searchString.length)) {
